...
public class ProcuratoreFrame extends JFrame {
	...
	public void setProcuratori(List<Procuratore> listaProcuratori) {
		...
		for(int i=0; i<listaProcuratori.size(); i++) model.addRow(new Object[] {listaProcuratori.get(i).getCodiceFiscale(), listaProcuratori.get(i).getNome(), listaProcuratori.get(i).getCognome(), listaProcuratori.get(i).getDataNascita()});
	}
